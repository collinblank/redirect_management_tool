...
function redirect_manager_custom_scripts()
{
	wp_enqueue_script('custom', get_template_directory_uri() . '/src/js/custom.js');
}
add_action('wp_enqueue_scripts', 'redirect_manager_custom_scripts');
