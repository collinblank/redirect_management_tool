    ...
    <form role="form" method="POST" class="form modal-form">
        <ul class="form__inputs-container">
            ...
            <li class="form__input-item">
                ...
                <input type="text" id="server-domain" name="server_domain" placeholder="ex. https://classicalconversations.com:7080/login.php" value="<?php echo $server_domain ?>" tabindex="2" pattern="^(?!https?:\/\/)(www\.)?([a-zA-Z0-9-]+)(\.[a-zA-Z]{2,})+$" required>
                <p class="form__input-item__msg"></p>
            </li>
        </ul>
