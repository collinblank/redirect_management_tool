        ...
        foreach ($results as $item) { ?>
            <li class="list-view__item <?php echo $item->disabled ? "disabled" : "" ?>" data-item-id=<?php echo $item->id; ?>>
                ...
                <div class="list-view__item__btns-container">
                    <button class="icon-btn edit-btn" title="Edit Server"><i class="fa-regular fa-pen-to-square"></i></button>
                    <?php if ($item->disabled) : ?>
                        <button class="icon-btn enable-btn" title="Enable Server"><i class="fa-regular fa-circle-check"></i></button>
                    <?php else : ?>
                        <button class="icon-btn disable-btn" title="Disable Server"><i class="fa-regular fa-circle-xmark"></i></button>
                    <?php endif; ?>
