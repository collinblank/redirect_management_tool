    ...
    foreach ($results as $server) { ?>
        <li class="list-view__item">
            ...
            <div class="list-view__item__btns-container">
                <button class="default-btn edit-btn"><img src="<?php get_template_directory_uri() . "/src/assets/icons/edit.svg" ?>" alt="edit icon"></button>
                <button class="default-btn disable-btn"><img src="x-octagon.svg" alt="x stop sign icon"></button>
